    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-secondary/30 to-background">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-bold text-primary">MiGente</h1>
          <p className="text-lg text-muted-foreground">{isLogin ? "¡Bienvenido de vuelta!" : "Creá tu cuenta"}</p>
        </div>
        ...
        <Card className="p-8 shadow-xl border-2">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" size="lg" className="w-full text-lg h-14 font-semibold">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="w-full text-lg h-14 font-semibold bg-transparent"
